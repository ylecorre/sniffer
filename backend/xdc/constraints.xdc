...
set_property PACKAGE_PIN C9 [get_ports rmiiMdc]						
set_property IOSTANDARD LVCMOS33 [get_ports rmiiMdc]
##Bank = 16, Pin name = IO_L14N_T2_SRCC_16,					Sch name = ETH_MDIO
set_property PACKAGE_PIN A9 [get_ports rmiiMdio]					
set_property IOSTANDARD LVCMOS33 [get_ports rmiiMdio]
##Bank = 35, Pin name = IO_L10P_T1_AD15P_35,					Sch name = ETH_RSTN
set_property PACKAGE_PIN B3 [get_ports rmiiRn]					
set_property IOSTANDARD LVCMOS33 [get_ports rmiiRn]
##Bank = 16, Pin name = IO_L6N_T0_VREF_16,					Sch name = ETH_CRSDV
set_property PACKAGE_PIN D9 [get_ports rmiiCrs]						
set_property IOSTANDARD LVCMOS33 [get_ports rmiiCrs]
...
set_property PACKAGE_PIN D10 [get_ports {rmiiRxd[0]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {rmiiRxd[0]}]
#Bank = 16, Pin name = IO_L13P_T2_MRCC_16,					Sch name = ETH_RXD1
set_property PACKAGE_PIN C11 [get_ports {rmiiRxd[1]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {rmiiRxd[1]}]
##Bank = 16, Pin name = IO_L11N_T1_SRCC_16,					Sch name = ETH_TXEN
set_property PACKAGE_PIN B9 [get_ports rmiiTxen]					
set_property IOSTANDARD LVCMOS33 [get_ports rmiiTxen]
##Bank = 16, Pin name = IO_L14P_T2_SRCC_16,					Sch name = ETH_TXD0
set_property PACKAGE_PIN A10 [get_ports {rmiiTxd[0]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {rmiiTxd[0]}]
##Bank = 16, Pin name = IO_L12N_T1_MRCC_16,					Sch name = ETH_TXD1
set_property PACKAGE_PIN A8 [get_ports {rmiiTxd[1]}]				
set_property IOSTANDARD LVCMOS33 [get_ports {rmiiTxd[1]}]
##Bank = 35, Pin name = IO_L11P_T1_SRCC_35,					Sch name = ETH_REFCLK
set_property PACKAGE_PIN D5 [get_ports rmiiRefClk]				
set_property IOSTANDARD LVCMOS33 [get_ports rmiiRefClk]
