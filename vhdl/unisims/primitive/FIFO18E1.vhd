  ...
  begin
	...
	if (sync = '1') then
      ...
      if (sync_clk_async_mode = '1') then
        ...
        -- fix for 724006
        if (rdcount_var - 1 = wr_addr_var and (wren_var = '1' or full_zd = '1')) then
          full_zd <= full_int(1);
        end if;
...
architecture FIFO18E1_V of FIFO18E1 is
  ...
  signal IS_RDCLK_INVERTED_reg : std_ulogic := IS_RDCLK_INVERTED;
  signal IS_RDEN_INVERTED_reg : std_ulogic := IS_RDEN_INVERTED;
  signal IS_RSTREG_INVERTED_reg : std_ulogic := IS_RSTREG_INVERTED;
  signal IS_RST_INVERTED_reg : std_ulogic := IS_RST_INVERTED;
  signal IS_WRCLK_INVERTED_reg : std_ulogic := IS_WRCLK_INVERTED;
  signal IS_WREN_INVERTED_reg : std_ulogic := IS_WREN_INVERTED;
...
begin
  ...
  RDCLK_in <= RDCLK xor IS_RDCLK_INVERTED_reg;
  RDEN_in <= RDEN xor IS_RDEN_INVERTED_reg;
  RSTREG_in <= RSTREG xor IS_RSTREG_INVERTED_reg;
  RST_in <= RST xor IS_RST_INVERTED_reg;
  WRCLK_in <= WRCLK xor IS_WRCLK_INVERTED_reg;
  WREN_in <= WREN xor IS_WREN_INVERTED_reg;
